    ...
    function (Constants) {
        "use strict";
            ...
            */
            ...
            return this.promisizer(jQuery.sap.getModulePath("EjercicioApi20.EjercicioApi20") + "/localService/" + sJsonName);
            },

            getOrdersDetail: async function(){
            ...
            getOrders: async function(sParam){
                const oRequest = this.getRequest({
                    endPoint: "Northwind",
                    method: "GET",
                    entity: Constants.routes.Entitys.orders + sParam + ")"
                });
                return this.promisizer(oRequest);
            },
            ...
            */
            ...
            return jQuery.sap.getModulePath("EjercicioApi20.EjercicioApi20") + "/";
            },
